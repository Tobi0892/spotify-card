!function (e) {
    ...
    function o(t, o) {
        ...
        for (o && null != o.children && (n.length || n.push(o.children), delete o.children); n.length;) if ((r = n.pop()) && void 0 !== r.pop) for (l = r.length; l--;) n.push(r[l]); else "boolean" == typeof r && (r = null), (a = "function" != typeof t) && (null == r ? r = "" : "number" == typeof r ? r = String(r) : "string" != typeof r && (a = !1)), a && s ? c[c.length - 1] += r : c === i ? c = [r] : c.push(r), s = a;
        var p = new e;
    ...
    var a = "function" == typeof Promise ? Promise.resolve().then.bind(Promise.resolve()) : setTimeout,
        l = /acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i, c = [];
    ...
    function C(e, t, n, i, o) {
        ...
        var p = s.firstChild, d = s.__preactattr_, v = t.children;
        if (null == d) {
            d = s.__preactattr_ = {};
        ...
        return !x && v && 1 === v.length && "string" == typeof v[0] && null != p && void 0 !== p.splitText && null == p.nextSibling ? p.nodeValue != v[0] && (p.nodeValue = v[0]) : (v && v.length || null != p) && function (e, t, n, i, o) {
            var s, r, a, l, c, p = e.childNodes, d = [], u = {}, f = 0, m = 0, v = p.length, g = 0,
                _ = t ? t.length : 0;
            if (0 !== v) for (var b = 0; b < v; b++) {
                var x = p[b], w = x.__preactattr_, k = _ && w ? x._component ? x._component.__key : w.key : null;
                null != k ? (f++, u[k] = x) : (w || (void 0 !== x.splitText ? !o || x.nodeValue.trim() : o)) && (d[g++] = x)
            }
            if (0 !== _) for (var b = 0; b < _; b++) {
                l = t[b], c = null;
                var k = l.key;
                if (null != k) f && void 0 !== u[k] && (c = u[k], u[k] = void 0, f--); else if (m < g) for (s = m; s < g; s++) if (void 0 !== d[s] && h(r = d[s], l, o)) {
        ...
        }(s, v, n, i, x || null != d.dangerouslySetInnerHTML), function (e, t, n) {
            var i;
    ...
    function N(e, t, n) {
        var i, o = P.length;
        for (e.prototype && e.prototype.render ? (i = new e(t, n), E.call(i, t, n)) : ((i = new E(t, n)).constructor = e, i.render = D); o--;) if (P[o].constructor === e) return i.nextBase = P[o].nextBase, P.splice(o, 1), i;
        return i
    }
    ...
    function L(e, t, n, i) {
        if (!e._disable) {
            var o, r, a, l = e.props, c = e.state, p = e.context, d = e.prevProps || l, h = e.prevState || c,
                u = e.prevContext || p, y = e.base, m = e.nextBase, v = y || m, b = e._component, x = !1, C = u;
    ...
    var I = function (e, t, n, i) {
        ...
        return a(), r
    }, U = "function" == typeof Map, z = U ? new Map : {}, A = U ? function (e) {
        var t = z.get(e);
    ...
    class j extends E {
        constructor() {
            super(), this.state = {selectedDevice: "-- choose mediaplayer --", castEntities: []}
        }
        ...
        async refreshCastEntities() {
            const e = (await this.props.hass.callWS({type: "config/entity_registry/list"})).filter(e => "cast" == e.platform).map(e => this.props.hass.states[e.entity_id]).filter(e => null != e);
            this.setState({castEntities: e})
        }
        ...
        componentWillReceiveProps(e, t) {
            e.selectedDevice && this.setState({selectedDevice: e.selectedDevice.name})
        }

        selectDevice(e) {
            this.setState({selectedDevice: e.name}), this.props.onMediaplayerSelect(e)
        }
        ...
        render() {
            const {devices: e} = this.props, {castEntities: t} = this.state, n = W`
    ...
    `;
            let i = "";
            if (this.props.player && this.props.player == this.state.selectedDevice) i = ""; else if (this.props.player && this.props.player != this.state.selectedDevice) {
    ...
    class H extends E {
        ...
        async checkAuthentication() {
            const e = new URLSearchParams(window.location.hash.substring(1)),
                ...
                o = await fetch("https://api.spotify.com/v1/me", {headers: i}).then(e => e.json());
        ...
        async refreshPlayData() {
            ...
            const e = {Authorization: `Bearer ${localStorage.getItem(this.getLocalStorageTokenName())}`};
            let t;
            t = this.props.featuredPlaylists ? await fetch("https://api.spotify.com/v1/browse/featured-playlists?limit=" + this.props.limit, {headers: e}).then(e => e.json()).then(e => e.playlists.items) : await fetch("https://api.spotify.com/v1/me/playlists?limit=" + this.props.limit, {headers: e}).then(e => e.json()).then(e => e.items);
            const n = await fetch("https://api.spotify.com/v1/me/player/devices", {headers: e}).then(e => e.json()).then(e => e.devices),
                i = await fetch("https://api.spotify.com/v1/me/player", {headers: e});
            let o, s = null, r = null;
        ...
        authenticateSpotify() {
            const e = window.location.href.split("?")[0], {clientId: t} = this.props;
        ...
        playPlaylist() {
            ...
            e && t ? fetch("https://api.spotify.com/v1/me/player/play?device_id=" + t.id, {
                ...
                body: JSON.stringify({context_uri: e.uri})
            }).then(() => this.setState({playingPlaylist: e})) : console.error("Will not play because there is no playlist or device selected,", e, t)
        }

        onPlaylistSelect(e) {
            this.setState({selectedPlaylist: e}), this.playPlaylist()
        }

        onMediaPlayerSelect(e) {
            this.setState({selectedDevice: e}), this.state.currentPlayer && fetch("https://api.spotify.com/v1/me/player", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem(this.getLocalStorageTokenName())}`
                },
                body: JSON.stringify({device_ids: [e.id], play: !0})
            })
        }
        ...
        onChromecastDeviceSelect(e) {
            ...
            const n = {device_name: e, uri: t.uri, transfer_playback: null != this.state.currentPlayer};
            this.props.account && (n.account = this.props.account), this.props.hass.callService("spotcast", "start", n)
        }

        getHighlighted(e) {
            const {selectedPlaylist: t} = this.state, n = t ? t.id : "";
      ...
      `;
            const o = {height: this.props.height ? parseInt(this.props.height) : "auto"};
            return q`
      <div class="spotify_container">
        <${V} />
    ...
    const V = () => q`
`, O = R.bind(o), F = document.createElement("style"), G = "rgb(30, 215, 96)", J = "rgb(40, 40, 40)",
        K = "rgb(24, 24, 24)", Q = "rgb(170, 170, 170)", X = "rgb(200, 200, 200)", Y = "rgb(255, 255, 255)";
    F.textContent = `\n    
    .spotify_container {
    ...
    customElements.define("spotify-card", class extends HTMLElement {
        constructor() {
            super(), this.shadow = this.attachShadow({mode: "open"}), this.config = {}
        }
